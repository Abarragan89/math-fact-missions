...
function MyApp({ Component, pageProps }) {
  ...
  return <AppProvider>
    <Head>
      ...
      <meta name='keywords' content='math fact missions, math fact mission, math, games, educational games, elementary, student, teacher, fluency, multiplication, addition, subtraction, division, facts, fact'
      />
